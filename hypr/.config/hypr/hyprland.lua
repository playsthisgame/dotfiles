...
local ai          = browser .. " --app=https://claude.ai"
local lockscreen  = "wlogout"
...
hl.bind(secondMod .. " + Q", hl.dsp.exec_cmd(lockscreen))
...
-- hl.bind("CONTROL + k", hl.dsp.focus({ direction = "up" }))
-- hl.bind("CONTROL + j", hl.dsp.focus({ direction = "down" }))
...
-- hl.bind("CONTROL + SHIFT + T", hl.dsp.window.float({ action = "toggle" }))
-- hl.bind("CONTROL + SHIFT + F", hl.dsp.window.fullscreen({ mode = "maximized" }))
